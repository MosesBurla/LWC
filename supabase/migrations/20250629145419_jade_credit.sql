/*
  ...
  1. Sample Data
    - Groups with proper meeting schedules and tags
    - Events with location and online meeting details
    - Devotionals with scripture references
    - Community posts and announcements
    - Prayer requests with different categories and statuses

  2. Data Structure
    - Uses JSONB for structured data (meeting schedules, locations, scripture)
    - Uses arrays for tags and media URLs
    - Proper timestamp handling for events
